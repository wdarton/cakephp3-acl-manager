...
class AclController extends AppController {
     ...
     * Manage Permissions
     */
    public function permissions($model = 'UserGroups') {
    ...
    public function updateAcos() {
        $this->UserAction->logActionAcl(__FILE__, 'Update ACOs');
    ...
    public function updateAros() {
        $this->UserAction->logActionAcl(__FILE__, 'Update AROs');
    ...
    public function revokePerms() {
        $this->UserAction->logActionAcl(__FILE__, 'Permissions revoked and defaults set');
    ...
    public function drop() {
        $this->UserAction->logActionAcl(__FILE__, 'Drop ACOs and AROs');
    ...
    public function defaults() {
        $this->UserAction->logActionAcl(__FILE__, 'Drop and set default ACOs and AROs');
